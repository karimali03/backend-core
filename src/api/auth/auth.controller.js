...
class AuthController {
    ...
    changePassword = asyncFun(async (req, res) => {
        ...
        return response.success(res, "Password changed successfully. You can now sign in.");
    });
     ...
     */
    getMe = asyncFun(async (req, res) => {
        // req.user is set by validateAuth middleware
        return response.success(res, "User authenticated", { user: req.user });
    });
}
